...
@Component
public class RecruiterServiceInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (generatedUrl.equals(EmailRegistrationService.getGeneratedUrl())) {
            response.sendRedirect("/v1/recruiter/register");
            return false;
        } else {
            return true;
        }
